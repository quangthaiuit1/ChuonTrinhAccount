...
public class DepartmentServicePublicServiceLocator extends org.apache.axis.client.Service implements trong.lixco.com.servicepublic.DepartmentServicePublicService {
    ...
    public DepartmentServicePublicServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for DepartmentServicePublicPort
    private java.lang.String DepartmentServicePublicPort_address = StaticPath.getPath()+"/dulieutrungtam_ejb/DepartmentServicePublic";
    ...
    public trong.lixco.com.servicepublic.DepartmentServicePublic getDepartmentServicePublicPort() throws javax.xml.rpc.ServiceException {
    ...
    public trong.lixco.com.servicepublic.DepartmentServicePublic getDepartmentServicePublicPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            trong.lixco.com.servicepublic.DepartmentServicePublicServiceSoapBindingStub _stub = new trong.lixco.com.servicepublic.DepartmentServicePublicServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (trong.lixco.com.servicepublic.DepartmentServicePublic.class.isAssignableFrom(serviceEndpointInterface)) {
                trong.lixco.com.servicepublic.DepartmentServicePublicServiceSoapBindingStub _stub = new trong.lixco.com.servicepublic.DepartmentServicePublicServiceSoapBindingStub(new java.net.URL(DepartmentServicePublicPort_address), this);
                _stub.setPortName(getDepartmentServicePublicPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://servicepublic.com.lixco.trong/", "DepartmentServicePublicPort"));
        }
